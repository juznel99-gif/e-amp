...
export const CompressorIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export const DelayIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M21.5 12a9.5 9.5 0 11-19 0 9.5 9.5 0 0119 0z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 12a7.5 7.5 0 11-15 0 7.5 7.5 0 0115 0z" opacity="0.5"/>
    </svg>
);
...
export const NoiseGateIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 3.375c-1.332 0-2.555.37-3.668.985L3.34 9.77a.75.75 0 000 1.06l4.992 4.992c1.113.615 2.336.985 3.668.985s2.555-.37 3.668-.985l4.992-4.992a.75.75 0 000-1.06L15.668 4.36C14.555 3.74 13.332 3.375 12 3.375z" />
...
export const ReverbIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 8.25c-2.335 0-4.5.78-6.25 2.183-1.75 1.403-3 3.388-3 5.567h18c0-2.18-1.25-4.164-3-5.567C16.5 9.03 14.335 8.25 12 8.25z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 8.25V6" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.75V4.5" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M15 8.25V6" />
    </svg>
);

export const KaraokeIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 9l10.5-3m0 6.553v3.75a2.25 2.25 0 01-1.632 2.163l-1.32.377a1.803 1.803 0 11-.99-3.467l2.31-.66a2.25 2.25 0 001.632-2.163zm0 0V7.5A2.25 2.25 0 0013.5 6h-3a2.25 2.25 0 00-2.25 2.25v1.5M12 12.75a2.25 2.25 0 00-2.25 2.25v3.75a2.25 2.25 0 002.25 2.25h.513a2.25 2.25 0 002.25-2.25v-3.75a2.25 2.25 0 00-2.25-2.25H12z" />
    </svg>
);
